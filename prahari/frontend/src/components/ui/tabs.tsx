...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn('inline-flex h-9 items-center rounded-lg bg-prahari-surface p-1 border border-prahari-border', className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      'text-prahari-muted',
      'data-[state=active]:bg-prahari-card data-[state=active]:text-prahari-cyan data-[state=active]:shadow-sm',
      className
    )}
    {...props}
  />
