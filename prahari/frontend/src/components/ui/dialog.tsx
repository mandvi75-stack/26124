  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'w-full max-w-lg rounded-lg border border-prahari-border bg-prahari-card shadow-2xl',
    ...
    >
      ...
      <DialogClose className="absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none disabled:pointer-events-none">
        <X className="h-4 w-4 text-prahari-muted" />
      </DialogClose>
    </DialogPrimitive.Content>
  </DialogPortal>
))
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description ref={ref} className={cn('text-sm text-prahari-muted', className)} {...props} />
))
